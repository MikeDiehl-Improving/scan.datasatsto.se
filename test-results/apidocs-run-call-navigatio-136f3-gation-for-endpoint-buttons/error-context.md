...
- Name: apidocs-run-call-navigation-e2e.spec.js >> uses navigation for endpoint buttons
- Location: tests\e2e\apidocs-run-call-navigation-e2e.spec.js:82:5
...
Call log:
  - waiting for locator('tr[data-path="/new/:event"]').first().locator('[name="event"]')
