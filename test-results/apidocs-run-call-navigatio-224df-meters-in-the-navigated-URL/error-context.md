...
- Name: apidocs-run-call-navigation-e2e.spec.js >> encodes parameters in the navigated URL
- Location: tests\e2e\apidocs-run-call-navigation-e2e.spec.js:53:5
...
Call log:
  - waiting for locator('tr[data-path="/report/:event"]').getByLabel('Event')
