...
- Name: apidocs-run-call-navigation-e2e.spec.js >> does not submit when a required parameter is empty
- Location: tests\e2e\apidocs-run-call-navigation-e2e.spec.js:69:5
...
Call log:
  - waiting for locator('tr[data-path="/report/:event"]').getByRole('button', { name: 'Run call' })
