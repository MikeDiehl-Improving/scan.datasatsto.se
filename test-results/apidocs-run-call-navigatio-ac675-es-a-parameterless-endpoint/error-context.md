...
- Name: apidocs-run-call-navigation-e2e.spec.js >> navigates a parameterless endpoint
- Location: tests\e2e\apidocs-run-call-navigation-e2e.spec.js:5:5
...
Locator: locator('tr[data-path="/expire"]').locator('.api-result')
Expected: ""
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" locator('tr[data-path="/expire"]').locator('.api-result') with timeout 5000ms
  - waiting for locator('tr[data-path="/expire"]').locator('.api-result')
