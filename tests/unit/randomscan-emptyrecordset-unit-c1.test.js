...
describe('random scan lookup with no matching records', () => {
    ...
    /* treegress:obligation randomscan.emptyrecordset.unit.c1 do-not-regenerate — for: Verify random scans endpoint returns 200 and an empty JSON array when no records match the event
